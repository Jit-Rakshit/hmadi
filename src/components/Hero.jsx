    ...
    <section className="hero" role="banner">
      ...
      <div className="hero-background">
        <img
          ...
          alt="Elegant salon interior with modern styling stations"
      ...
      <div className="hero-content container">
        ...
        <p className="hero-subtitle">Beauty, Coffee & Cheesecake</p>
        <p className="hero-tagline">Your moment of self-care.</p>
